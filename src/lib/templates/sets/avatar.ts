...
/**
 * 400×400. Eight treatments of the same mark — never a redrawn or per-pillar symbol.
...
export const avatarTemplates: TemplateDef[] = [
  ...
  { ...base, id: "av-founder", name: "Avatar · Photo / founder", surface: "foundation", accent: "brass", text: { headline: "AM" } },
];
